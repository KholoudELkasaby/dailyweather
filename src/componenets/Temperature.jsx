  ...
  return (
    <>
      <div className="flex align-middle justify-center">
        <input
          type="text"
          className="bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none dark:bg-blue-50 dark:text-slate-900 dark:border-slate-200  "
      ...
      <div className="flex justify-center">
        {stats.isDay !== 0 ? (
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-12 h-12 text-slate-200 mt-8 dark:text-slate-900"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
