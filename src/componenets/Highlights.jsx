...
function Highlights({ stats }) {
  return (
    <div className="bg-slate-600 p-2 text-slate-200 flex flex-col justify-start items-center dark:bg-slate-200 dark:text-slate-800 ">
      ...
      {stats.direction ? (
        <div className="flex mt-4">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 h-6 text-slate-200 dark:text-slate-900"
          >
            <path
              strokeLinecap="round"
